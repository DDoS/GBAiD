...
public class GameBoyAdvance {
    ...
    public static class GameBoyAdvanceMemory : MappedMemory {
        ...
        private MonitoredMemory ioRegisters;
        private Memory vram;
        private Memory oam;
        ...
        private this(string biosFile) {
            ...
            ioRegisters = new MonitoredMemory(new RAM(IO_REGISTERS_SIZE));
        ...
        public MonitoredMemory getIORegisters() {
            return ioRegisters;
        }
    ...
    public static class DMAs {
        ...
        private this(GameBoyAdvanceMemory memory, InterruptHandler interruptHandler, MonitoredMemory ioRegisters) {
            this.memory = memory;
    ...
    private static class Timers {
        ...
        public this(InterruptHandler interruptHandler, MonitoredMemory ioRegisters) {
            this.interruptHandler = interruptHandler;
            this.ioRegisters = ioRegisters.getMonitored();
        ...
        private class TimerMemoryMonitor : MonitoredMemory.MemoryMonitor {
